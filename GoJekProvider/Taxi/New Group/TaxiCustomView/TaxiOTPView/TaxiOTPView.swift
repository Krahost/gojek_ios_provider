...
class TaxiOTPView: UIView {
    ...
    var onClickStartTripButton:((String)->Void)?
    var onClickCloseButton:((String)->Void)?
    ...
    override func awakeFromNib() {
        ...
        startTripButton.backgroundColor = .taxiColor
...
//                ToastManager.show(title: TaxiConstant.InvalidOTP.localized , state: .error)
//                return
                //responseOTP = checkOtp
            }
       }
        onClickStartTripButton?(checkOtp)
    }
}

extension TaxiOTPView: UITextFieldDelegate {
