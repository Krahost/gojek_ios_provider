...
extension CourierInvoiceCell{
    ...
    private func setText(){
        deliveryHeadingLabel.text = OrdersConstant.delivery.uppercased().localized
        ...
        staticPackageLabel.text = OrdersConstant.packageType.localized
        staticDescriptionLabel.text = OrdersConstant.instruction.localized
