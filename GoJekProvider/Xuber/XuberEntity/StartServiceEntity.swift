...
struct StartServiceEntity : Mappable {
    var statusCode : String?
    var title : String?
    var message : String?
    var responseData : StartServiceResponseData?
    var error : [String]?
...
struct StartServiceResponseData : Mappable {
    var id : Int?
